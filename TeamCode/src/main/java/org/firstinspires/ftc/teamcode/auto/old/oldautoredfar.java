...
@Config
@Configurable
@Autonomous(name = "Meet 2-RED Far", preselectTeleOp = "Meet 2.0 Teleop")
public class oldautoredfar extends LinearOpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            line1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(87.000, 8.000), new Pose(105.000, 34.000))
                    )
