...
//@Disabled
//@Config
//@Autonomous(name = "BADBADRED Far Corner-STATE", preselectTeleOp = "STATE Teleop", group = "Red Goal")
//public class ZBADBADRedFarCornerNINE extends NextFTCOpMode {
//
//
//
//    public ZBADBADRedFarCornerNINE() throws InterruptedException {
//        addComponents(
