...
public class flywheeltuningpidf extends OpMode {
    ...
    double P = 0;    // Proportional gain to correct error based on how far off the velocity is.
    double I = 0.0;     // Not sure we really need this but <shrug> -Crocker
