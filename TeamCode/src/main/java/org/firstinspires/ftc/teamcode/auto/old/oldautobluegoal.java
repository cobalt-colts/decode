...
@Config
@Configurable
@Autonomous(name = "Meet 2-BLUE Goal", preselectTeleOp = "Meet 2.0 Teleop")
public class oldautobluegoal extends LinearOpMode {
...
//                }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        follower.setStartingPose(new Pose(21.5, 125, Math.toRadians(320)));
