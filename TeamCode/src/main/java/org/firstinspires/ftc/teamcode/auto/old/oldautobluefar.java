...
@Config
@Configurable
@Autonomous(name = "Meet 2-BLUE Far", preselectTeleOp = "Meet 2.0 Teleop")
public class oldautobluefar extends LinearOpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            line1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(60.000, 8.000), new Pose(38.000, 34.000))
                    )
...
//                }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        follower.setStartingPose(new Pose(60, 8, Math.toRadians(270)));
...
// Glenn 12/6/2025 so we don't drive
                ...
                case 1:
                    if (!follower.isBusy() && throwervelocity >= 700) {
