...
public class lifttest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("11 green: ", color11.green());
            telemetry.addData("12 green: ", color12.green());
            telemetry.addData("21 green: ", color21.green());
            telemetry.addData("22 green: ", color22.green());
            telemetry.addData("31 green: ", color31.green());
            telemetry.addData("32 green: ", color32.green());
            telemetry.addData("11 blue: ", color11.blue());
            telemetry.addData("12 blue: ", color12.blue());
            telemetry.addData("21 blue: ", color21.blue());
            telemetry.addData("22 blue: ", color22.blue());
            telemetry.addData("31 blue: ", color31.blue());
            telemetry.addData("32 blue: ", color32.blue());
