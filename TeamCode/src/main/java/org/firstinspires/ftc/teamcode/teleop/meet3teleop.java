...
public class meet3teleop extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        color22 = hardwareMap.colorSensor.get("f2s2");
        color31 = hardwareMap.colorSensor.get("f3s1");
        color32 = hardwareMap.colorSensor.get("f3s2");
        lift1 = hardwareMap.servo.get("flicker1");
        lift2 = hardwareMap.servo.get("flicker2");
        lift3 = hardwareMap.servo.get("flicker3");
